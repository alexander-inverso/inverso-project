...
/* El selector de idioma (ESP · ENG · CAT) vive en su propio módulo
   autónomo (i18n.js), cargado aparte en index.html, para que el cambio
   de idioma funcione aunque este fondo de WebGL falle al cargar. */
